...
enum yxulinux_connect_state {
  YXU_CONNECT_UNKNOWN = 0,          // 未初始化或已断开
  YXU_CONNECT_CREATED_SESSION,      // 已创建session
  YXU_CONNECT_CONNECTED,            // 连接成功
  YXU_CONNECT_VERIFY_HOST,          // 已验证主机
  YXU_CONNECT_AUTH,                 // 完成用户登录认证
};


#define YXU_S_IFMT_CHAR    "017"
#define YXU_S_IFSOCK_CHAR  "014"      // 套接字
#define YXU_S_IFLNK_CHAR   "012"      // 符号链接
#define YXU_S_IFREG_CHAR   "010"      // 普通文件
#define YXU_S_IFBLK_CHAR   "006"      // 块设备
#define YXU_S_IFDIR_CHAR   "004"      // 文件夹
#define YXU_S_IFCHR_CHAR   "002"      // 字符设备
#define YXU_S_IFIFO_CHAR   "001"      // 命名管道	


#define YXU_S_IFMT   00170000
#define YXU_S_IFSOCK 0140000
#define YXU_S_IFLNK  0120000
#define YXU_S_IFREG  0100000
#define YXU_S_IFBLK  0060000
#define YXU_S_IFDIR  0040000
#define YXU_S_IFCHR  0020000
#define YXU_S_IFIFO  0010000
